...
int main(int argc,char ** argv)
{
    ...
    // Load model
//    std::unique_ptr<tflite::FlatBufferModel> model = tflite::FlatBufferModel::BuildFromFile("inception_v2_224_quant.tflite");
...
//    frame=imread("tabby.jpeg");//schoolbus.jpg");  //need to refresh frame before dnn class detection
    frame=imread("bird_1.jpeg");  //need to refresh frame before dnn class detection
    if (frame.empty()) {
